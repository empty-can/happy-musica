...
?>
		...
		<div id="navigation_menu">
			<div id="menu_wrapper">
<?php if(isset($id_hisoty[$screen_name.':'.$end])) {?>
			<div id="next" class="button">
					<a
						href="./?screen_name=<?php echo $screen_name;?>&count=<?php echo $count;?>&max_id=<?php echo $id_hisoty[$screen_name.':'.$end];?>">◀</a>
				</div>
				　　<?php echo $counter;?> / <?php echo $callNum;?>*200
<?php } else { ?>
...
<?php } ?>
			...
			<div id="back" class="button">
					<a
						href="./?screen_name=<?php echo $screen_name;?>&count=<?php echo $count;?>&max_id=<?php echo $end;?>">▶</a>
				</div>
			</div>
		</div>
		<div id="bottom_menu">
