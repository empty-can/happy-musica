...
<body id="body" onload="loadTimeLine();">
	<div id="bottom_menu">
		...
		<div id="toTop" class="button" onclick="switchShowTweet()">
...
if($tweet->isVideoTweet()) {
    ?>
    <div class="img_wrapper">
        <video src="<?php echo $tweet->getVideoURL(); ?>" poster="<?php echo $tweet->getAllMediaURL()[0]; ?>" controls>
				...
				<div id="info_wrapper<?php echo $tweet->getId();?>" class="info_wrapper">
					<div class="info">
						<div class="user">
								...
								?>
								<a href="/osaisen/timeline/?name=<?php echo $tweet->getName();?>&screen_name=<?php echo $tweet->getScreenName();?>&count=50" target="_blank">
									<img src="<?php echo $tweet->getProfileImgURL();?>" />
								</a>
                				<?php } ?>
						</div>
...
<?php } ?>
	...
	<div id="dummy"></div>
	<div id="bottom" style="color:white; text-align:center;z-index:100;"></div>
    </div>
</body>
</html>